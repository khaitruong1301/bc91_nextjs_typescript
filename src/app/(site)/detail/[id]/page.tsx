...
import ListButtonImg from "@/app/(components)/containerPages/DetailComponent/ListButtonImg";

const getProductDetailById = async (id: string): Promise<ResponseData<ProductVM> | null> => {
    try {

        //cache 5 phút
        const res = await fetch(`https://apistore.cybersoft.edu.vn/api/Product/getbyid?id=${id}`, { cache: 'force-cache' , next: { revalidate: 300 }});
            ...
            <div className="row mb-5">
                ...
                <div className="col-lg-4 col-md-5 mb-4 mb-lg-0">
                    <div className="card border-0 shadow-sm">
                        <ImageProduct prodDetail={prodDetail} />
                    </div>
